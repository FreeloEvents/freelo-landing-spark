...
const FAQ: React.FC = () => {
  const faqs: FAQItem[] = [
    {
      question: "כיצד אתם שומרים על הפרטיות שלי?",
    ...
    {
      question: "איך נרשמים לאירועים פרטיים או מוגבלים?",
    ...
    {
      question: "איך Freelo מתאימה לי אירועים אישית?",
    ...
    {
      question: "האם הפלטפורמה מתאימה גם למתחילים?",
    ...
    {
      question: "איזה אמצעי בטיחות קיימים באירועים?",
